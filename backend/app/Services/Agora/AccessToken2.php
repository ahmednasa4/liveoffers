...
/**
 * Agora AccessToken2 (version 007) — common service type & privilege payload.
 *
 * Ported from AgoraIO/Tools DynamicKey/AgoraDynamicKey/php/src/AccessToken2.php.
 */
...
class AccessToken2
{
    ...
    public function parse($token)
    {
        ...
        $serviceClasses = [
            ServiceRtc::SERVICE_TYPE => ServiceRtc::class,
            ServiceRtm::SERVICE_TYPE => ServiceRtm::class,
            ServiceStreaming::SERVICE_TYPE => ServiceStreaming::class,
            ServiceFpa::SERVICE_TYPE => ServiceFpa::class,
            ServiceChat::SERVICE_TYPE => ServiceChat::class,
            ServiceFCdn::SERVICE_TYPE => ServiceFCdn::class,
            ServiceApaas::SERVICE_TYPE => ServiceApaas::class,
            ServiceRtm2::SERVICE_TYPE => ServiceRtm2::class,
        ];
