...
/**
 * Binary packing/unpacking helpers for Agora AccessToken2 (version 007).
 *
 * Ported from AgoraIO/Tools DynamicKey/AgoraDynamicKey/php/src/Util.php.
 * All integers are packed in little-endian order.
 */
class Util
{
    /**
